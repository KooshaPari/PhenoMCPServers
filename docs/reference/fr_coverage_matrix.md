...
| `FR-AGENT_USER_STATUS-004` | Caching layer with TTL support | IMPLEMENTED | COVERED | 7 | `tests/unit/test_statusd_cache.py`<br>`tests/unit/test_ttl_cache.py` | TTL cache hit, expiry, copy isolation, bounded eviction, subprocess-backed statusd caching, and invalidation covered. |
