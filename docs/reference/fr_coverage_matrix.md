...
| `FR-AGENT_USER_STATUS-009` | Configuration management | IMPLEMENTED | COVERED | 15 | `tests/unit/test_agent_imessage_recipients.py`<br>`tests/unit/test_bootstrap_support.py`<br>`tests/unit/test_packaging_macos.py`<br>`tests/unit/test_validate_docs.py` |  |
