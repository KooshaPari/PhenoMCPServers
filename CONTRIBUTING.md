...
This repo controls a local user-status runtime, native monitor, iMessage
bridge, and privacy-sensitive attention telemetry. Treat every change as
local operator infrastructure unless proven otherwise.
...
Call out privacy impact in every pull request that touches a collector,
backend, CLI, or monitor surface.
